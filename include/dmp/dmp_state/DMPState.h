...
protected:
    ...
    uint                dmp_num_dimensions;         // number of dimensions in the DMP, for example: Cartesian DMP has 3 dimensions, Quaternion DMP has 4 dimensions, etc.
    double              time;                       // "time" variable here is used to accomodate trajectory training data which came from a different sampling rate
    ...
    VectorN             x;                          // vector of length N, with n-th component represent the position of the n-th DMP trajectory
    VectorN             xd;                         // vector of length N, with n-th component represent the velocity of the n-th DMP trajectory
    VectorN             xdd;                        // vector of length N, with n-th component represent the acceleration of the n-th DMP trajectory
    //double            sensitive_unused_variable;	// toogle commenting/uncommenting this variable if DMP does NOT work (very STRANGE problem, unknown reason)
