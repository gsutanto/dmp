...
class LearningSystemDiscrete : public LearningSystem {
 ...
 private:
  ...
  VectorN max_coord;  // maximum coordinate in the trajectory, for each
                      // dimension (reserved for future use)
 ...
 public:
   ...
   * @param transformation_system_discrete Discrete transformation system
   * associated with this discrete learning system
   * @param data_logging_system DMPDataIODiscrete associated with this discrete
   * learning system
   * @param selected_learning_method Learning method that will be used to learn
   * the DMP basis functions' weights\n 0=_SCHAAL_LWR_METHOD_: Stefan Schaal's
   ...
   *
   * @return Discrete learning system is valid (true) or discrete learning
  ...
  /**
   * NON-REAL-TIME!!!\n
   * Learns and updates weights of the given discrete function approximator
   * based on the given set of trajectories.
   *
