 ...
 *  Can be learned with the help of locally-weighted regression (LWR).
 *
 *  See A.J. Ijspeert, J. Nakanishi, H. Hoffmann, P. Pastor, and S. Schaal;
 *      Dynamical movement primitives: Learning attractor models for motor behaviors;
 *      Neural Comput. 25, 2 (February 2013), 328-373
 *
 *  Additional Note: If anyone is asking the reason why FuncApproximatorDiscrete (FunctionApproximator) is
 *  being separated from LearningSystemDiscrete (LearningSystem), please see the description (or top comments)
 *  in FunctionApproximator.h.
 *
...
private:
    ...
    VectorMPtr  psi;        // psi vector is the same across all DMP dimensions, so we don't need a matrix here
...
public:
     ...
     * @return Success or failure
     */
    bool getBasisFunctionVector(double x,
