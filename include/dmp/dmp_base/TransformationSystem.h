...
public:
     ...
     */
    TransformationSystem(uint dmp_num_dimensions_init,  CanonicalSystem* canonical_system,
                         ...
                         DMPState* current_velocity_dmpstate=NULL, GoalSystem* goal_system=NULL,
     ...
     */
    virtual bool start(const DMPState& start_state_init, const DMPState& goal_state_init) = 0;
     ...
     *
     * @param accumulated_ct_acc The accumulated acceleration-level transformation system coupling term value (to be returned)
     * @param accumulated_ct_vel The accumulated velocity-level transformation system coupling term value (to be returned)
     * @return Success or failure
     */
    virtual bool getCouplingTerm(VectorN& accumulated_ct_acc, VectorN& accumulated_ct_vel);
    ...
    virtual bool setCouplingTermUsagePerDimensions(const std::vector<bool>& is_using_coupling_term_at_dimension_init);
