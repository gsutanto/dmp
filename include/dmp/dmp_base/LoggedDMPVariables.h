 ...
 *
 *  Temporary buffer to store the current value of the DMP variables
 * to-be-logged. The values stored here will later be copied into data
 * structures of trajectories in DMPDataIO, and eventually be dumped into a file
...
class LoggedDMPVariables {
 ...
 public:
   ...
   * debugging
   */
  LoggedDMPVariables(uint dmp_num_dimensions_init, uint num_basis_functions,
