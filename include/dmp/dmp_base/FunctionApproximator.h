 ...
 *  that can approximate a given trajectory. There are 2 reasons why this
 * (FunctionApproximator) is being separated from the LearningSystem, as
 * follows: (1) For Modularity: FunctionApproximator here is solely/ONLY
 * dependent on canonical state variable(s) (of CanonicalSystem), and nothing
 * else. Hence it is easily modifiable without affecting other systems too much.
 *  (2) For Real-Time-Safety: most functions in FunctionApproximator are
 * required to be real-time-safe, while most functions in LearningSystem are NOT
 * real-time-safe. Hence it is better to separate these two.
 *
...
class FunctionApproximator {
 ...
 public:
   ...
   * @param canonical_system Canonical system that drives this function
   * approximator
