...
protected:
    ...
    MatrixNxMPtr            learned_weights;    // pointer to the matrix of learned weights (matrix of size dmp_num_dimensionsXmodel_size)
...
public:
    ...
    /**
     * NON-REAL-TIME!!!\n
     * Learns the function approximator parameters (weights, etc.) based on the given set of trajectories.
     *
