...
class CanonicalSystem {
 ...
 public:
   ...
   * temporal DMP development \n (please note that this is a pointer to vector
   ...
   *
   * @return Canonical system is valid (true) or canonical system is invalid
   * (false)
   */
  ...
  /**
   * Returns the canonical multiplier of the system (especially relevant in
   * CanonicalSystemDiscrete child class).
   */
   ...
   *
   * @param accumulated_cc The accumulated canonical system coupling term value
   * (to be returned)
   * @return Success or failure
   */
