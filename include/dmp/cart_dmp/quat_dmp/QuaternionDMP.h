...
class QuaternionDMP : public DMPDiscrete {
 ...
 public:
   ...
   * re-usability)
   */
  QuaternionDMP(uint model_size_init,
   ...
   */
  bool startQuaternionDMP(const QuaternionTrajectory& critical_states,
                          double tau_init);
   ...
   * @return Success or failure
   */
  bool getTargetQuaternionCouplingTermAndUpdateStates(
