 ...
 *
 *  Spring-damper based transformation system of a Quaternion DMP for a discrete (non-rhythmic) orientation movement
 *
 *  See G. Sutanto, Z. Su, G. Loeb, F. Meier, and S. Schaal;
 *      Learning Associative Skill Memory-guided Feedback Term for Reactive Planning;
 *      in preparation, June 2017
 *
...
public:
     ...
     */
    TransformSystemQuaternion(CanonicalSystemDiscrete* canonical_system_discrete,
     ...
     */
    bool startTransformSystemQuaternion(const QuaternionDMPState& start_state_init, const QuaternionDMPState& goal_state_init);
     ...
     * using the desired start and goal states.
     *
     ...
     * @return Success or failure
     */
    bool getNextQuaternionState(double dt, QuaternionDMPState& next_state,
     ...
     * @return Success or failure
     */
    bool getTargetQuaternionForcingTerm(const QuaternionDMPState& current_state_demo_local, VectorN& f_target);
     ...
     * @return Success or failure
     */
    bool getTargetQuaternionCouplingTerm(const QuaternionDMPState& current_state_demo_local, VectorN& ct_acc_target);
     ...
     * @return Success or failure
     */
    bool setCurrentQuaternionGoalState(const QuaternionDMPState& new_current_goal_state);
