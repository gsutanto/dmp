...
public:
     ...
     */
    TransformSystemDiscrete(uint dmp_num_dimensions_init,
                            ...
                            DMPState* start_dmpstate_discrete=NULL, DMPState* current_dmpstate_discrete=NULL,
                            DMPState* current_velocity_dmpstate_discrete=NULL, GoalSystem* goal_system_discrete=NULL,
     ...
     * @return Success or failure
     */
    bool getNextState(double dt, DMPState& next_state,
