...
private:
     ...
     *                   FuncApproximatorDiscrete's weights and TransformSystemDiscrete's A_learn together; \n
     *                   See getParams(), setParams(), saveParams(), and loadParams(), which are also \n
...
public:
     ...
     * @return Success or failure
     */
    bool getNextState(double dt, bool update_canonical_state, DMPState& next_state,
