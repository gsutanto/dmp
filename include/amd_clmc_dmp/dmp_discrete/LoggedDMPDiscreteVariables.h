 ...
 *
 *  Temporary buffer to store the current value of the discrete DMP variables to-be-logged.
 *  The values stored here will later be copied into data structures of trajectories in DMPDataIODiscrete,
