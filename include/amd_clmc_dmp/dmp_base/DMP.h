 ...
 *  CanonicalSystem, FunctionApproximator, TransformationSystem, LearningSystem, and external couplings
 *
...
protected:
    ...
    VectorN                 mean_start_position;    // average start position of the training set of trajectories
    VectorN                 mean_goal_position;     // average goal position of the training set of trajectories
...
public:
     ...
     * @return Success or failure
     */
    virtual bool getNextState(double dt, bool update_canonical_state,
                              DMPState& next_state, VectorN* transform_sys_forcing_term=NULL,
                              ...
                              VectorM* func_approx_normalized_basis_func_vector_mult_phase_multiplier=NULL) = 0;
     ...
     * @return Success or failure
     */
    virtual bool getTargetCouplingTermAndUpdateStates(const DMPState& current_state_demo_local,
                                                      const double& dt,
