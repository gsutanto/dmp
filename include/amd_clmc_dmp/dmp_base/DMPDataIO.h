 ...
 * DMPDataIO.h
 *
 *  Data loading, data collection, and data saving of DMP parameters and variables from/to file(s).
 *
...
public:
     ...
     * @return Success or failure
     */
    virtual bool collectTrajectoryDataSet(const LoggedDMPVariables& logged_dmp_variables_buffer);
