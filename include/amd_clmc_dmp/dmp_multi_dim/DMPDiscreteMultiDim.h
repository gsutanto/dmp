/*
 * DMPDiscreteMultiDim.h
 *
 *  This implements a multi-dimensional Discrete DMP.
 *
...
class DMPDiscreteMultiDim : public DMPDiscrete
{

protected:

    TransformSystemDiscrete     transform_sys_discrete_multi_dim;
...
public:
     ...
     */
    DMPDiscreteMultiDim(uint dmp_num_dimensions_init, uint model_size_init,
