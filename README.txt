...
Open the file <workspace>/src/catkin/planning/dmp/python/dmp_test/dmp_1D/dmp_1D_test.py
...
Open the file <workspace>/src/catkin/planning/dmp/python/dmp_test/cart_dmp/cart_coord_dmp/cart_coord_dmp_single_traj_training_test.py
Execute ("Run") the file inside the Spyder IDE.
(it will generate some plots comparing the training/demonstration data (in dotted blue line) versus the unrolled trajectory from the learned DMP primitive (in solid green line))
(2.b) Learning from Multiple Trajectories
Open the file <workspace>/src/catkin/planning/dmp/python/dmp_test/cart_dmp/cart_coord_dmp/cart_coord_dmp_multi_traj_training_test.py
Execute ("Run") the file inside the Spyder IDE.
...
Open the file <workspace>/src/catkin/planning/dmp/python/dmp_test/cart_dmp/quat_dmp/quat_dmp_single_traj_training_test.py
Execute ("Run") the file inside the Spyder IDE.
(it will generate some plots comparing the training/demonstration data (in dotted blue line) versus the unrolled trajectory from the learned DMP primitive (in solid green line))
(3.b) Learning from Multiple Trajectories
Open the file <workspace>/src/catkin/planning/dmp/python/dmp_test/cart_dmp/quat_dmp/quat_dmp_multi_traj_training_test.py
Execute ("Run") the file inside the Spyder IDE.
(it will generate some plots comparing the training/demonstration data (in dotted blue lines) versus the unrolled trajectory from the learned DMP primitive (in solid green line))
...
------
Go to inside <workspace>/devel/lib/dmp/ folder (if using CATKIN installation)
(1) 1-Dimensional DMP Test:
...
./dmp_dc_loa_so_sb_single_demo_demo [-f formula_type(0=_SCHAAL_ OR 1=_HOFFMANN_)] [-c canonical_order(1 OR 2)] [-m learning_method(0=_SCHAAL_LWR_METHOD_ OR 1=_JPETERS_GLOBAL_LEAST_SQUARES_METHOD_)] [-o loa_output_file_path] [-e rt_err_file_path]
(3.b) Multiple Demonstration Settings
./dmp_dc_loa_so_sb_multi_demo_demo [-f formula_type(0=_SCHAAL_ OR 1=_HOFFMANN_)] [-c canonical_order(1 OR 2)] [-m learning_method(0=_SCHAAL_LWR_METHOD_ OR 1=_JPETERS_GLOBAL_LEAST_SQUARES_METHOD_)] [-r regularization_const] [-o loa_output_file_path] [-e rt_err_file_path]
...
$ cd <workspace>/src/catkin/planning/dmp/software_test/
$ ./get_original_software_test_dir_abs_path.sh
$ cd <workspace>/devel/lib/dmp/
$ cp -r <workspace>/src/catkin/planning/dmp/software_test/ ../
