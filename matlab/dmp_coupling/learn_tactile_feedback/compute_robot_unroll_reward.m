...
for uti = 1:length(unroll_types)
    data_dir_path       = ['/home/zhesu_local/Desktop/dmp_robot_unroll_results/scraping/',experiment_name,'/robot/',env_setting_name,'/',unroll_types{1,uti}];
