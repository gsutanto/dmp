function [] = prepareData(task_type, dataset_Ct_tactile_asm, out_data_dir, ...
        ...
        for np=1:N_primitive
            if (is_evaluating_autoencoder)
                [ X, Ct_target, ...
                  ...
                  X_dim_reduced_autoencoder ]   = stackDataset( dataset_Ct_tactile_asm, subset_settings_indices, ...
                                                                mode_stack_dataset, subset_outlier_ranked_demo_indices_cell{type}, feature_type, np );
            else
                [ X, Ct_target, ...
                  normalized_phase_PSI_mult_phase_V, ~, ~, ...
                  X_dim_reduced, ...
                  data_point_priority ] = stackDataset( dataset_Ct_tactile_asm, subset_settings_indices, ...
                                                        mode_stack_dataset, subset_outlier_ranked_demo_indices_cell{type}, feature_type, np );
            end
