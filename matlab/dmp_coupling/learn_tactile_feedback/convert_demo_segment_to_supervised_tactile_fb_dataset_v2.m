...
%   dataset.
%   Version 2: Learned baseline/nominal action primitives is provided.
...
% use old dmp baseline/nominal parameters instead 
% (because it was used during correction demos, 
%  by unrolling it on the robot while also activating force/torque control
%  to allow correction demonstrations by a human subject):
action_dmp_baseline_params  = load(['../../../data/dmp_coupling/learn_tactile_feedback/',specific_task_type,'/action_dmp_baseline_params_',specific_task_type,'.mat'], 'action_dmp_baseline_params');
dmp_baseline_params         = action_dmp_baseline_params.action_dmp_baseline_params;

smoothed_data_demo_human_baseline   = load(['smoothed_data_demo_human_baseline_',specific_task_type,'.mat'],'smoothed_data_demo_human_baseline');
smoothed_data_demo          = smoothed_data_demo_human_baseline.smoothed_data_demo_human_baseline;

clearvars                   action_dmp_baseline_params smoothed_data_demo_human_baseline;
...
save(['data_demo_',generic_task_type,'.mat'],'data_demo');
...
save(['dmp_baseline_params_',generic_task_type,'.mat'],'dmp_baseline_params');
...
save(['dataset_Ct_tactile_asm_',generic_task_type,'.mat'],'dataset_Ct_tactile_asm');
save(['smoothed_data_demo_',generic_task_type,'.mat'],'smoothed_data_demo');
