...
for i=1:size(obs_list,2)
    [ X_gTruth_cell{i,1}, Yo_cell{i,1}, Ydo_cell{i,1}, Yddo_cell{i,1}, ~, ~, Ct_SYNTH_cell{i,1} ] = ...
        constructSynthObsAvoidCircleTraj( w_primitive, w_ct_synth, start_pos, goal_pos,...
...
for i=1:size(obs_list,2)
    [ X_observed_cell{i,1}] = constructObsAvoidCircleFeatMat2D( Yo_cell{i,1}, Ydo_cell{i,1}, ...
