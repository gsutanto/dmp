function [ result ] = computeTwiceLogQuatDifference( quat_p, quat_q, varargin )
    ...
    if (is_standardizing_quat_diff == 0)        % if NOT standardizing before applying Log Mapping
        result  = 2 * computeLogMapQuat(computeQuatProduct(...
        ...
        result  = 2 * computeLogMapQuat(standardizeNormalizeQuaternion(...
                                            computeQuatProduct(...
                                                normalizeQuaternion(quat_p), ...
                                                computeQuatConjugate(quat_q))));
    end
