...
logs_path = "/tmp/pmnnv2/iter_learn_unroll/frac/"
...
pmnnv2_model_parent_dir_path='../tf/models/'
pmnnv2_model_file_path = None
pmnnv2_name = 'my_PMNNv2_obs_avoid_fb'
...
loa_parameters = TCLearnObsAvoidFeatureParameter(D_input,
                                                 ...
                                                 pmnnv2_model_parent_dir_path, 
                                                 pmnnv2_model_file_path,
                                                 PMNNV2_MODEL, pmnnv2_name)
...
with pmnnv2_graph.as_default():
    ...
    # PMNNv2 is initialized with parameters specified in filepath:
    pmnnv2 = PMNNv2(pmnnv2_name, D_input, 
    ...
    if (is_using_L_BFGS_B == False):
        ...
        if (is_performing_weighted_training):
            loss_dim0 = pmnnv2.computeWeightedLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 0, tf_train_W_batch)
            loss_dim1 = pmnnv2.computeWeightedLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 1, tf_train_W_batch)
            loss_dim2 = pmnnv2.computeWeightedLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 2, tf_train_W_batch)
        else:
            loss_dim0 = pmnnv2.computeLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 0)
            loss_dim1 = pmnnv2.computeLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 1)
            loss_dim2 = pmnnv2.computeLossPerDimOut(train_batch_prediction, tf_train_Ctt_batch, beta, 2)
