...
void print_usage()
{
    printf("Usage: dmp_ct_loa_so_sb_multi_demo_vicon_unrolling_demo [-f formula_type(0=_SCHAAL_ OR 1=_HOFFMANN_)] [-c canonical_order(1 OR 2)] [-m learning_method(0=_SCHAAL_LWR_METHOD_ OR 1=_JPETERS_GLOBAL_LEAST_SQUARES_METHOD_)] [-r regularization_const] [-o loa_plot_dir_path] [-w ct_loa_weights_subpath] [-e rt_err_file_path]\n");
}
