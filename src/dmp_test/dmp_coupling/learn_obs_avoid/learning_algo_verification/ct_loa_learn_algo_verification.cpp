...
void print_usage()
{
    printf("Usage: amd_clmc_dmp_ct_loa_learn_algo_verification_demo [-f formula_type(0=_SCHAAL_ OR 1=_HOFFMANN_)] [-c canonical_order(1 OR 2)] [-m learning_method(0=_SCHAAL_LWR_METHOD_ OR 1=_JPETERS_GLOBAL_LEAST_SQUARES_METHOD_)] [-o loa_plot_dir_path] [-e rt_err_file_path]\n");
}
