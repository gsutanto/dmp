...
TransformSystemDiscrete::TransformSystemDiscrete(
    ...
    std::unique_ptr<DMPState> start_dmpstate_discrete,
    std::unique_ptr<DMPState> current_dmpstate_discrete,
    std::unique_ptr<DMPState> current_velocity_dmpstate_discrete,
    std::unique_ptr<GoalSystem> goal_system_discrete,
    ...
    : TransformationSystem(dmp_num_dimensions_init,
                           ...
                           func_approximator_discrete.get(),
                           logged_dmp_discrete_vars, real_time_assertor,
                           std::move(start_dmpstate_discrete),
                           std::move(current_dmpstate_discrete),
                           std::move(current_velocity_dmpstate_discrete),
                           std::move(goal_system_discrete), transform_couplers),
