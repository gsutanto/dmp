...
DMPDiscreteMultiDim::DMPDiscreteMultiDim():
    transform_sys_discrete_multi_dim(TransformSystemDiscrete(0, NULL,
                                                             &func_approx_discrete,
                                                             std::vector<bool>(0, true),
                                                             _SCHAAL_DMP_, &logged_dmp_discrete_variables,
                                                             NULL, NULL, NULL, NULL, NULL, NULL)),
    DMPDiscrete(0, 0, NULL, &transform_sys_discrete_multi_dim, _SCHAAL_LWR_METHOD_, NULL, "")
{}
 ...
 */
DMPDiscreteMultiDim::DMPDiscreteMultiDim(uint dmp_num_dimensions_init, uint model_size_init,
    ...
    transform_sys_discrete_multi_dim(TransformSystemDiscrete(dmp_num_dimensions_init, canonical_system_discrete,
                                                             &func_approx_discrete,
    ...
    DMPDiscrete(dmp_num_dimensions_init, model_size_init, canonical_system_discrete, &transform_sys_discrete_multi_dim,
...
bool DMPDiscreteMultiDim::isValid()
{
    ...
    if (rt_assert(transform_sys_discrete == &transform_sys_discrete_multi_dim) == false)
    {
        return false;
    }
 ...
 */
bool DMPDiscreteMultiDim::extractSetTrajectories(const char* dir_or_file_path,
                                                 ...
                                                 uint max_num_trajs)
{
    ...
    if (rt_assert(data_logger_loader_discrete.extractNDTrajectory(dir_or_file_path, *trajectory)) == false)
    {
        return false;
    }
