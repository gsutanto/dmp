...
dmp_software_test_dir_abs_path=$(<../software_test/dmp_software_test_dir_abs_path.txt)
devel_software_test_dir_abs_path=$(pwd)/../software_test/

matlab -nodisplay -nodesktop -nosplash -nojvm -r \
"cd('$dmp_software_test_dir_abs_path/../matlab/dmp_1D/'); \
testDMP1DFitAndUnroll('$devel_software_test_dir_abs_path/'); \
cd('$dmp_software_test_dir_abs_path/../matlab/cart_dmp/cart_coord_dmp/'); \
testCartCoordDMPFitAndUnroll('$devel_software_test_dir_abs_path/'); \
cd('$dmp_software_test_dir_abs_path/../matlab/cart_dmp/quat_dmp/'); \
testQuaternionDMPUnroll('$devel_software_test_dir_abs_path/'); \
testQuaternionDMPFitAndUnroll('$devel_software_test_dir_abs_path/'); \
cd('$dmp_software_test_dir_abs_path/../data/dmp_coupling/learn_tactile_feedback/scraping/neural_nets/pmnn/python_models/'); \
...
cd('$dmp_software_test_dir_abs_path/../matlab/dmp_coupling/learn_tactile_feedback/neural_nets/unroll/for_verification/'); \
testCoupledCartDMPUnroll('$devel_software_test_dir_abs_path/'); \
cd('$dmp_software_test_dir_abs_path/../matlab/utilities/'); \
